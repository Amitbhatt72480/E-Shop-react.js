	...
	return (
		<>
			<div className=" mt-5 bg-white text-black">
				<h1 className="pt-12 text-center py-4  font-f2 text-bold tracking-widest xl:text-5xl text-2xl md:text-4xl ">Featured Products</h1>
				<div className=" mt-10 space-y-10 lg:space-y-0 lg:grid lg:grid-cols-3 justify-items-center">
					<div className="">
				...
				<div className='flex'>
					<button onClick={handleNavigate} className="mx-auto mb-10 btn">All Products</button>
				</div>
			</div>
		</>
	)
